...
import { Cloud, CloudRain, Sun, Wind, Calendar, Play, ChevronRight, MapPin, Zap } from 'lucide-react';
...
export default function WeatherSpectrum() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentTemp(prev => prev + (Math.random() > 0.5 ? 1 : -1));
    }, 5000);
  ...
  const forecast = [
    ...
    { day: 'Thu', high: 78, low: 62, condition: 'Sunny', icon: Sun },
    { day: 'Fri', high: 71, low: 55, condition: 'Storms', icon: CloudRain },
    { day: 'Sat', high: 69, low: 52, condition: 'Windy', icon: Wind },
    { day: 'Sun', high: 73, low: 56, condition: 'Clear', icon: Sun },
  ];
      ...
      <div className="relative z-10">
        ...
        <section className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="bg-white rounded-3xl p-10 shadow-xl border border-stone-200 hover:shadow-2xl transition-shadow">
            ...
            <h4 className="text-3xl font-bold mb-6 text-stone-900">The Great Ice Storm of 1998</h4>
            <p className="text-stone-600 leading-relaxed text-lg mb-6">
              One of the most devastating ice storms in North American history began, coating parts of Eastern Canada 
              and the Northeastern United States with up to 4 inches of ice. The storm caused widespread power outages 
              affecting millions and resulted in 35 deaths.
            </p>
